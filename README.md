...
<a href="https://keunal.id/author/juwandi/">
  <img src="https://img.shields.io/badge/🌐_Portfolio-Visit_Website-blue?style=for-the-badge&logo=wordpress&logoColor=white">
</a>
...
📍 **Bogor, Indonesia** &nbsp; | &nbsp; 💼 **Freelance at Naeta** &nbsp; | &nbsp; 🎓 **Universitas Terbuka**
...
**[🇯🇵]**
こんにちは、ジュワンディと申します。現在、インドネシアでデータサイエンスを専攻しています。**データ分析のロジック**と**グラフィックデザインの感性**を融合させ、視覚的にわかりやすいインサイトを提供できるのが私の強みです。将来的には日本のAI企業で、技術と創造性を活かして貢献したいと考えています。現在、日本語能力試験(JLPT)の学習も継続中です。

**[🇬🇧]**
Hi, I'm Juwandi! I bridge the gap between **Data Science** and **Visual Design**. Currently mastering Machine Learning & NLP while refining my Japanese skills to pursue a career in Tokyo's tech industry.
...
| :--- | :--- |
| Kumpulan proyek Analisis Data, Machine Learning, dan NLP dengan dokumentasi teknis lengkap. | Portofolio Desain Grafis, Web Development (Keunal.id), dan konten media sosial. |
